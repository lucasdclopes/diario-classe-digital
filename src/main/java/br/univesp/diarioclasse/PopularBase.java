...
public class PopularBase  {
	...
	public void run() throws Exception {
		alunoDal.saveAll(Arrays.asList(
				new Aluno("123456",LocalDate.now(),"11111", Optional.empty(), "Lex Murphy", "11111111", "1111111111", LocalDate.now(), 
						Sexo.MASCULINO, "Mãe do Joãozinho", "Pai do Joãozinho"),
				new Aluno("123457",LocalDate.now(),"11112", Optional.empty(), "Tim Murphy", "2222222222", "222222222", LocalDate.now(), 
						Sexo.FEMININO, "Mãe do Joãozinho", "Pai do Joãozinho"),
				new Aluno("123458",LocalDate.now(),"11113", Optional.empty(), "Dennis Nedry", "3333333333", "333333333", LocalDate.now(), 
						Sexo.MASCULINO, "Mãe do Joãozinho", "Pai do Joãozinho")
				));
